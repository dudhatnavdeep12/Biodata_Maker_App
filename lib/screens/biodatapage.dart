...
import 'package:biodata_maker_app/models/my_data.dart';
import 'package:biodata_maker_app/utils/utils.dart';
...
class _BioDataPageState extends State<BioDataPage> {
  ...
  Future<void> generatePdf() async {
    ...
    final String path = '$dir/BioData.pdf';
    print(path);
        ...
        child: ListView(
          children: [
            Container(
              ...
              padding: EdgeInsets.only(top: 15, left: 7, bottom: 15),
